const translations = {
    en: {
        ...
        faqA1: "Check-in is from 15:00 and check-out is by 11:00. Self check-in is available with keyless entry, guided by our step-by-step online check-in form.",
        faqQ2: "Is there a minimum stay?",
        faqA2: "Yes, the minimum stay is 3 nights.",
        faqQ3: "What is the cancellation policy?",
        faqA3: "Free cancellation up to 14 days before check-in.",
        faqQ4: "Is parking included?",
        faqA4: "Yes, private garage parking is included with the apartment.",
        faqQ5: "Are pets allowed?",
        faqA5: "No, pets are not allowed at the property.",
        faqQ6: "What fees are added to the nightly rate?",
        faqA6: "A one-time cleaning fee of CHF 150 and a city tax of CHF 6 per adult per night are added at checkout.",
        faqQ7: "How far is the apartment from Geneva Airport?",
        faqA7: "Geneva Airport is about 55 minutes away by train, with Montreux train station just 8 minutes on foot from the apartment.",
        ...
        ciPassportNotice: "Please have your passport ready — a photo or scan of it is required to complete your online check-in.",
        ciStartBtn: "Proceed to Online Check-in →",
        ...
        ciLabelPassportFile: "Passport Photo / Scan (required)",
        ...
        ciErrPassportFile: "Please upload a photo or scan of your passport to continue.",
    ...
    fr: {
        ...
        // Contact
        faqLabel: "Bon à Savoir",
        faqTitle: "Questions Fréquentes",
        faqQ1: "Quels sont les horaires d'arrivée et de départ ?",
        faqA1: "L'arrivée se fait à partir de 15h00 et le départ avant 11h00. Le check-in autonome est disponible avec accès sans clé, guidé par notre formulaire d'enregistrement en ligne étape par étape.",
        faqQ2: "Y a-t-il une durée de séjour minimale ?",
        faqA2: "Oui, la durée minimale de séjour est de 3 nuits.",
        faqQ3: "Quelle est la politique d'annulation ?",
        faqA3: "Annulation gratuite jusqu'à 14 jours avant l'arrivée.",
        faqQ4: "Le parking est-il inclus ?",
        faqA4: "Oui, une place de parking privée en garage est incluse avec l'appartement.",
        faqQ5: "Les animaux sont-ils autorisés ?",
        faqA5: "Non, les animaux ne sont pas autorisés dans la propriété.",
        faqQ6: "Quels frais s'ajoutent au tarif par nuit ?",
        faqA6: "Des frais de ménage uniques de CHF 150 et une taxe de séjour de CHF 6 par adulte et par nuit sont ajoutés au moment du paiement.",
        faqQ7: "À quelle distance se trouve l'appartement de l'aéroport de Genève ?",
        faqA7: "L'aéroport de Genève est à environ 55 minutes en train, la gare de Montreux se trouvant à seulement 8 minutes à pied de l'appartement.",
        ...
        ciPassportNotice: "Veuillez avoir votre passeport à portée de main — une photo ou un scan de celui-ci est requis pour terminer votre enregistrement en ligne.",
        ciStartBtn: "Procéder à l'Enregistrement en Ligne →",
        ...
        ciLabelPassportFile: "Photo / Scan du passeport (obligatoire)",
        ...
        ciErrPassportFile: "Veuillez téléverser une photo ou un scan de votre passeport pour continuer.",
    ...
    de: {
        ...
        faqQ1: "Wann sind Check-in und Check-out?",
        faqA1: "Check-in ist ab 15:00 Uhr und Check-out bis 11:00 Uhr. Selbst-Check-in mit schlüssellosem Zugang ist verfügbar und wird durch unser Schritt-für-Schritt-Online-Formular geführt.",
        faqQ2: "Gibt es eine Mindestaufenthaltsdauer?",
        faqA2: "Ja, die Mindestaufenthaltsdauer beträgt 3 Nächte.",
        faqQ3: "Wie lautet die Stornierungsbedingung?",
        faqA3: "Kostenlose Stornierung bis 14 Tage vor Anreise.",
        faqQ4: "Ist ein Parkplatz inbegriffen?",
        faqA4: "Ja, ein privater Garagenparkplatz ist im Apartment inbegriffen.",
        faqQ5: "Sind Haustiere erlaubt?",
        faqA5: "Nein, Haustiere sind in der Unterkunft nicht erlaubt.",
        faqQ6: "Welche Gebühren kommen zum Übernachtungspreis hinzu?",
        faqA6: "Eine einmalige Reinigungsgebühr von CHF 150 sowie eine Kurtaxe von CHF 6 pro Erwachsenem und Nacht werden beim Checkout hinzugefügt.",
        faqQ7: "Wie weit ist das Apartment vom Flughafen Genf entfernt?",
        faqA7: "Der Flughafen Genf ist etwa 55 Minuten mit dem Zug entfernt, der Bahnhof Montreux liegt nur 8 Gehminuten vom Apartment entfernt.",
        ...
        ciPassportNotice: "Bitte halten Sie Ihren Reisepass bereit — ein Foto oder Scan davon ist erforderlich, um den Online-Check-in abzuschließen.",
        ciStartBtn: "Weiter zum Online-Check-in →",
        ciStep1: "Anmeldung",
        ciStep2: "Hausordnung",
        ciStep3: "Wellness & SPA",
        ...
        ciLabelPassportFile: "Reisepassfoto / -scan (erforderlich)",
        ...
        ciErrPassportFile: "Bitte laden Sie ein Foto oder einen Scan Ihres Reisepasses hoch, um fortzufahren.",
    ...
    ru: {
        ...
        faqQ1: "Каково время заезда и выезда?",
        faqA1: "Заезд с 15:00, выезд до 11:00. Доступна самостоятельная регистрация с бесключевым доступом с пошаговой онлайн-формой регистрации.",
        faqQ2: "Есть ли минимальный срок проживания?",
        faqA2: "Да, минимальный срок проживания — 3 ночи.",
        faqQ3: "Какова политика отмены бронирования?",
        faqA3: "Бесплатная отмена за 14 дней до заезда.",
        faqQ4: "Включена ли парковка?",
        faqA4: "Да, частная парковка в гараже включена в стоимость апартаментов.",
        faqQ5: "Разрешены ли домашние животные?",
        faqA5: "Нет, домашние животные в апартаментах не разрешены.",
        faqQ6: "Какие сборы добавляются к цене за ночь?",
        faqA6: "При оформлении добавляются единоразовый сбор за уборку в размере CHF 150 и туристический налог CHF 6 за взрослого за ночь.",
        faqQ7: "Как далеко апартаменты находятся от аэропорта Женевы?",
        faqA7: "Аэропорт Женевы находится примерно в 55 минутах на поезде, а вокзал Монтрё — всего в 8 минутах ходьбы от апартаментов.",
        ...
        ciPassportNotice: "Пожалуйста, приготовьте паспорт — для завершения онлайн-регистрации потребуется его фото или скан.",
        ciStartBtn: "Перейти к онлайн-регистрации →",
        ciStep1: "Регистрация",
        ...
        ciLabelPassportFile: "Фото / скан паспорта (обязательно)",
        ...
        ciErrPassportFile: "Пожалуйста, загрузите фото или скан вашего паспорта, чтобы продолжить.",
    ...
    ar: {
        ...
        // Contact
        faqLabel: "معلومات مفيدة",
        faqTitle: "الأسئلة الشائعة",
        faqQ1: "ما هي أوقات تسجيل الوصول والمغادرة؟",
        faqA1: "تسجيل الوصول من الساعة 15:00 وتسجيل المغادرة حتى الساعة 11:00. يتوفر تسجيل وصول ذاتي بدخول بدون مفتاح، موجه بواسطة نموذج تسجيل الوصول عبر الإنترنت خطوة بخطوة.",
        faqQ2: "هل هناك حد أدنى لمدة الإقامة؟",
        faqA2: "نعم، الحد الأدنى لمدة الإقامة هو 3 ليالٍ.",
        faqQ3: "ما هي سياسة الإلغاء؟",
        faqA3: "إلغاء مجاني حتى 14 يومًا قبل تسجيل الوصول.",
        faqQ4: "هل موقف السيارات مشمول؟",
        faqA4: "نعم، يشمل الشقة موقف سيارات خاص في المرآب.",
        faqQ5: "هل يُسمح بالحيوانات الأليفة؟",
        faqA5: "لا، لا يُسمح بالحيوانات الأليفة في العقار.",
        faqQ6: "ما هي الرسوم المضافة إلى السعر الليلي؟",
        faqA6: "تُضاف رسوم تنظيف لمرة واحدة قدرها 150 فرنكًا سويسريًا وضريبة مدينة قدرها 6 فرنكات سويسرية لكل بالغ لكل ليلة عند الدفع.",
        faqQ7: "ما مدى بُعد الشقة عن مطار جنيف؟",
        faqA7: "يبعد مطار جنيف حوالي 55 دقيقة بالقطار، وتبعد محطة قطار مونترو 8 دقائق فقط سيرًا على الأقدام من الشقة.",
        ...
        ciPassportNotice: "يرجى تجهيز جواز سفرك — تكون صورة أو مسح ضوئي له مطلوبًا لإتمام تسجيل الوصول عبر الإنترنت.",
        ciStartBtn: "المتابعة إلى تسجيل الوصول عبر الإنترنت →",
        ciStep1: "التسجيل",
        ...
        ciLabelPassportFile: "صورة / مسح جواز السفر (إلزامي)",
        ...
        ciErrPassportFile: "يرجى تحميل صورة أو مسح ضوئي لجواز سفرك للمتابعة.",
    ...
    zh: {
        ...
        faqTitle: "常见问题",
        faqQ1: "入住和退房时间是几点？",
        faqA1: "入住时间为15:00起，退房时间为11:00前。可通过我们的分步在线入住表格进行免钥匙自助入住。",
        faqQ2: "有最短入住天数要求吗？",
        faqA2: "有，最短入住天数为3晚。",
        faqQ3: "取消政策是什么？",
        faqA3: "入住前14天可免费取消。",
        faqQ4: "是否包含停车位？",
        faqA4: "是的，公寓包含私人车库停车位。",
        faqQ5: "是否允许携带宠物？",
        faqA5: "不允许，本房源不接受宠物。",
        faqQ6: "每晚房费之外还会收取哪些费用？",
        faqA6: "结账时将收取一次性150瑞士法郎的清洁费，以及每位成人每晚6瑞士法郎的城市税。",
        faqQ7: "公寓距离日内瓦机场有多远？",
        faqA7: "日内瓦机场乘火车约55分钟可达，蒙特勒火车站步行仅需8分钟即可到达公寓。",
        contactLabel: "联系我们",
        contactTitle: "联系方式",
        ...
        ciPassportNotice: "请准备好您的护照——完成在线入住需要提供护照照片或扫描件。",
        ciStartBtn: "前往在线入住 →",
        ciStep1: "登记",
        ciStep2: "楼栋规则",
        ciStep3: "Wellness & SPA",
        ...
        ciLabelPassportFile: "护照照片 / 扫描件（必填）",
        ...
        ciErrPassportFile: "请上传您的护照照片或扫描件以继续。",
