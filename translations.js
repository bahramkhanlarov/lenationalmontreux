const translations = {
    en: {
        ...
        ciLabelPassportFile: "Passport Photo / Scan (optional)",
        ciPassportFileHint: "Photo or PDF, max 8 MB.",
        ciPassportFileRemove: "Remove",
    ...
    fr: {
        ...
        ciLabelPassportFile: "Photo / Scan du passeport (facultatif)",
        ciPassportFileHint: "Photo ou PDF, max 8 Mo.",
        ciPassportFileRemove: "Supprimer",
        ciPassportFileTooBig: "Fichier trop volumineux (max 8 Mo).",
        ciPassportFileBadType: "Veuillez téléverser une image ou un fichier PDF.",
    ...
    de: {
        ...
        ciLabelPassportFile: "Reisepassfoto / -scan (optional)",
        ciPassportFileHint: "Foto oder PDF, max. 8 MB.",
        ciPassportFileRemove: "Entfernen",
        ciPassportFileTooBig: "Datei ist zu groß (max. 8 MB).",
        ciPassportFileBadType: "Bitte ein Bild oder eine PDF-Datei hochladen.",
    ...
    ru: {
        ...
        ciLabelPassportFile: "Фото / скан паспорта (необязательно)",
        ciPassportFileHint: "Фото или PDF, макс. 8 МБ.",
        ciPassportFileRemove: "Удалить",
        ciPassportFileTooBig: "Файл слишком большой (макс. 8 МБ).",
        ciPassportFileBadType: "Пожалуйста, загрузите изображение или PDF-файл.",
    ...
    ar: {
        ...
        ciLabelPassportFile: "صورة / مسح جواز السفر (اختياري)",
        ciPassportFileHint: "صورة أو PDF، بحد أقصى 8 ميجابايت.",
        ciPassportFileRemove: "إزالة",
        ciPassportFileTooBig: "الملف كبير جدًا (بحد أقصى 8 ميجابايت).",
        ciPassportFileBadType: "يرجى تحميل صورة أو ملف PDF.",
    ...
    zh: {
        ...
        ciLabelPassportFile: "护照照片 / 扫描件（可选）",
        ciPassportFileHint: "照片或 PDF，最大 8 MB。",
        ciPassportFileRemove: "移除",
        ciPassportFileTooBig: "文件过大（最大 8 MB）。",
        ciPassportFileBadType: "请上传图片或 PDF 文件。",
