const translations = {
  en: {
    ...
    bookingDesc: "Select your check-in and check-out dates below. Availability is synced in real time with our Airbnb calendar. Secure payment via Stripe. You will be redirected to complete your booking.",
